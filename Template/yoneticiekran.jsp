...
try {
		...
		ResultSet rs = st.executeQuery("SELECT * FROM egitmen;");
		while (rs.next()) {
		out.println("<tr><td>" + rs.getString("egitmenId") + "</td>");
		out.println("<td>" + rs.getString("egitmenAd") + "</td>");
		out.println("<td>" + rs.getString("egitmenSoyad") + "</td>");
		out.println("<td>" + rs.getString("egitmenNo") + "</td>");
		out.println("<td>" + rs.getString("dersId") + "</td></tr>");}}
                                        catch (Exception e){
                                			e.printStackTrace(); 
                                				}
...
%>
                                    ...
                                    </table> <a href="egitmeneDersEkle.html">Eğitmene Ders Ekle</a>
                                </div>
                            </div><!-- /flat-list-table -->
